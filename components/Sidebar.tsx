        ...
        <aside className="fixed top-0 left-0 w-64 h-full bg-[#0F172A] text-white flex flex-col no-print z-50 overflow-y-auto font-sans">
            ...
            <div className="p-4 border-t border-gray-800/50">
                <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/5 transition-colors cursor-pointer">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center text-sm font-bold shadow-lg shadow-indigo-500/20">
                        CM
                    </div>
                    <div>
